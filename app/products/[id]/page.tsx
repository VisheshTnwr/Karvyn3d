...
import AddToCartButton from "@/components/AddToCartButton"; // <-- Import the button component
      ...
      <section className="pt-40 pb-20 md:pb-32">
        <div className="container mx-auto max-w-7xl px-6">
          ...
          <div className="mb-8 text-left">
            ...
            <span className="text-gray-500 mx-2 text-sm">/</span>
            <span className="text-gray-300 text-sm font-semibold">{product.name}</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="space-y-8">
              <h1 className="text-5xl font-heading tracking-tight text-white">{product.name}</h1>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-heading text-white">Product Description</h3>
              ...
              {/* --- THIS IS THE UPDATE --- */}
              {/* We replaced the hardcoded HTML with our smart component */}
