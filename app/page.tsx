          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
                <a href="#gallery" className="px-10 py-4 text-lg font-bold text-black bg-accent rounded-xl shadow-lg hover-bg-accent transition-all">
                  See Our Work
                </a>
                <a href="#store" className="px-10 py-4 text-lg font-bold text-white bg-gray-900 rounded-xl hover:bg-gray-800 transition-all border border-gray-800">
                  Get Notified
                </a>
              </div>
            </div>
      ...
      <section id="gallery" className="py-24 md:py-40">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center max-w-3xl mx-auto mb-20 fade-in-section">
            <h2 className="text-5xl md:text-7xl font-heading text-white mb-6">ALL THE THINGS<br />WE <span className="text-accent">MAKE.</span></h2>
            <p className="text-xl text-gray-400 mt-6">
              Just a handful of our creations. From personalized gifts to stylish home decor, we bring your vision to life.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            
            {/* --- Item 1: Personalized --- */}
            <Link href="/category/personalized-gifts" className="block gallery-card">
              <div className="bg-gray-900 rounded-3xl overflow-hidden fade-in-section border border-gray-800 h-full">
                ...
                <div className="p-8">
                  ...
                  <p className="text-gray-400">Custom keychains, nameplates, and unique mementos for every occasion.</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/category/home-decor" className="block gallery-card">
              <div className="bg-gray-900 rounded-3xl overflow-hidden fade-in-section border border-gray-800 h-full">
                ...
                <div className="p-8">
                  ...
                  <p className="text-gray-400">Minimalist vases, geometric planters, and abstract sculptures to elevate your space.</p>
                </div>
              </div>
            </Link>

            {/* --- Item 3: Office --- */}
            <Link href="/category/office-gifting" className="block gallery-card">
              <div className="bg-gray-900 rounded-3xl overflow-hidden fade-in-section border border-gray-800 h-full">
                <GalleryImage 
                ...
                <div className="p-8">
                  ...
                  <p className="text-gray-400">Stylish desk organizers, phone stands, unique boxes, and custom clocks.</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/category/home-decor" className="block gallery-card">
              <div className="bg-gray-900 rounded-3xl overflow-hidden fade-in-section border border-gray-800 h-full">
                ...
                />
                <div className="p-8">
                  <h3 className="text-2xl font-heading text-white mb-2">Bespoke Clocks</h3>
                  <p className="text-gray-400">Functional art. We design and print custom clocks to match your exact style.</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/category/personalized-gifts" className="block gallery-card">
              <div className="bg-gray-900 rounded-3xl overflow-hidden fade-in-section border border-gray-800 h-full">
                ...
                />
                <div className="p-8">
                  <h3 className="text-2xl font-heading text-white mb-2">Photo Lithophanes</h3>
                  <p className="text-gray-400">Turn your memories into glowing 3D photos. The perfect heartfelt gift.</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/category/office-gifting" className="block gallery-card">
              <div className="bg-gray-900 rounded-3xl overflow-hidden fade-in-section border border-gray-800 h-full">
                ...
                />
                <div className="p-8">
                  <h3 className="text-2xl font-heading text-white mb-2">Custom Desk Plates</h3>
                  <p className="text-gray-400">Sharp, professional nameplates for your home office or as a corporate gift.</p>
                </div>
              </div>
            </Link>
          </div>
